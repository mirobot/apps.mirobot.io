...
IDE_Morph.prototype.createLogo = function () {
  ...
  this.logo = new Morph();
  this.logo.texture = "/apps.mirobot.io/assets/apps/snap/snap_logo_sm.png";
...
IDE_Morph.prototype.createCategories = function () {
  ...
  function fixCategoriesLayout() {
    var buttonWidth = myself.categories.children[0].width(),
      ...
      xPadding = (myself.categories.width() - border - buttonWidth * 2) / 3,
      yPadding = 2,
...
IDE_Morph.prototype.setExtent = function (point) {
  ...
  if (this.isAppMode) {
    minExt = StageMorph.prototype.dimensions.add(this.controlBar.height() + 10);
  } else {
...
IDE_Morph.prototype.cloudMenu = function () {
  ...
  if (!SnapCloud.username) {
    ...
    menu.addItem(localize("Logout") + " " + SnapCloud.username, "logout");
...
IDE_Morph.prototype.projectMenu = function () {
  ...
  menu.addItem(
    ...
    function () {
      var dir = "/apps.mirobot.io/assets/apps/snap/" + graphicsName,
  ...
  menu.addItem(
    localize("Sounds") + "...",
    function () {
      var names = this.getCostumesList(
          "/apps.mirobot.io/assets/apps/snap/Sounds/"
        ),
        libMenu = new MenuMorph(this, "Import sound");

      function loadSound(name) {
        var url = "/apps.mirobot.io/assets/apps/snap/Sounds/" + name,
          audio = new Audio();
        audio.src = url;
        audio.load();
...
IDE_Morph.prototype.rawSaveProject = function (name) {
  ...
  if (name) {
    ...
    if (Process.prototype.isCatchingErrors) {
      try {
        localStorage["-snap-project-" + name] = str = this.serializer.serialize(
          this.stage
        );
  ...
  if (name) {
    ...
    if (Process.prototype.isCatchingErrors) {
      try {
        ...
        str = encodeURIComponent(this.serializer.serialize(this.stage));
        //location.hash = '#open:' + str;
        window.open("data:text/" + (plain ? "plain," + str : "xml," + str));
        menu.destroy();
  ...
  if (Process.prototype.isCatchingErrors) {
    try {
      ...
      this.serializer.openProject(
        this.serializer.loadProjectModel(model.childNamed("project"), this),
        this
      );
    } catch (err) {
      this.showMessage("Load failed: " + err);
...
IDE_Morph.prototype.setLanguage = function (lang, callback) {
  var translation = document.getElementById("language"),
    src = "/apps.mirobot.io/assets/apps/snap/lang-" + lang + ".js",
    myself = this;
...
IDE_Morph.prototype.exportProjectMedia = function (name) {
  ...
  if (name) {
    ...
    if (Process.prototype.isCatchingErrors) {
      try {
        menu = this.showMessage("Exporting");
        encodeURIComponent(this.serializer.serialize(this.stage));
        media = encodeURIComponent(this.serializer.mediaXML(name));
      ...
      menu = this.showMessage("Exporting");
      encodeURIComponent(this.serializer.serialize(this.stage));
      media = encodeURIComponent(this.serializer.mediaXML());
      window.open("data:text/xml," + media);
      menu.destroy();
      this.showMessage("Exported!", 1);
    }
...
IDE_Morph.prototype.setCloudURL = function () {
  new DialogBoxMorph(null, function (url) {
    ...
    .withKey("cloudURL")
    .prompt("Cloud URL", SnapCloud.url, this.world(), null, {
...
IDE_Morph.prototype.getURLsbeOrRelative = function (url) {
  var request = new XMLHttpRequest(),
    myself = this;
  try {
    request.open("GET", "http://snap.berkeley.edu/snapsource/" + url, false);
    request.send();
    if (request.status === 200) {
      return request.responseText;
    }
...
ProjectDialogMorph.prototype.popUp = function (wrrld) {
  ...
  if (world) {
    ...
    this.handle = new HandleMorph(this, 350, 300, this.corner, this.corner);
  }
};
  ...
  if (this.source === "local") {
    ...
    this.listField.action = function (item) {
      ...
      src = myself.ide.getURL(
        "http://snap.berkeley.edu/snapsource/Examples/" + item.name + ".xml"
      );
...
ProjectDialogMorph.prototype.openProject = function () {
  ...
  if (this.source === "cloud") {
    ...
    src = this.ide.getURL(
      "http://snap.berkeley.edu/snapsource/Examples/" + proj.name + ".xml"
    );
...
CostumeIconMorph.prototype.editCostume = function () {
  if (this.object instanceof SVG_Costume) {
    ...
    this.object.edit(this.world(), this.parentThatIsA(IDE_Morph));
  }
};
