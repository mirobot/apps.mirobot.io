...
Blockly.Blocks['draw_move'] = {
  ...
  init: function() {
    var DIRECTIONS =
        [[BlocklyApps.getMsg('Turtle_moveForward'), 'forward'],
         [BlocklyApps.getMsg('Turtle_moveBackward'), 'back']];
    this.setColour(160);
...
Blockly.Blocks['draw_turn'] = {
  ...
  init: function() {
    var DIRECTIONS =
        [[BlocklyApps.getMsg('Turtle_turnRight'), 'right'],
         [BlocklyApps.getMsg('Turtle_turnLeft'), 'left']];
