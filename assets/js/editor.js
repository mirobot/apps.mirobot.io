...
Editor.prototype = {
  init: function (id) {
    var self = this;
    ace.config.set("workerPath", "/apps.mirobot.io/assets/apps/javascript/js/");
  ...
  initConsole: function () {
    ...
    this.console.innerHTML =
      '<button class="showButton">Show Console</button><button class="hideButton">Hide Console</button><pre></pre>';
    this.console
