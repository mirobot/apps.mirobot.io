...
trans.de = {
  ...
  ":new-prog": "Neues Programm",
  ":delete-prog": "Programm löschen",
  ":download": "Aktuelles Programm herunterladen",
  ":upload": "Programm hoch laden",
  ":open": "Programm öffnen",
  ":choose-name": "Dateiname auswählen",
  ":unsaved": "Ungesicherte Änderungen werden verloren gehen. Fortfahren?",
  ":exists": "Fehler: Eine Datei diese Namens existiert bereits",
  ":single-file": "Bitte nur eine einzelen Datei zum hoch laden auswählen",
  ":sure": "Sind Sie sicher, dass Sie das Programm löschen wollen?",
  ":permanent": "DIes ist permanent und kann nicht rückgängig gemacht werden",
  ":address": "Geben Sie hier die Adresse des Mirobot ein",
  ":connect": "Verbinden",
  ":connected": "Verbunden",
  ":move-cmd": "Fahre [[ direction ]] um [[ distance ]] mm",
  ":penup-cmd": "Stift hoch",
  ":pendown-cmd": "Stift runter",
  ":turn-cmd": "Drehe [[ direction ]] um [[ angle ]] Grad",
  ":repeat-cmd": "Wiederhole [[ count ]] mal",
  ":beep-cmd": "Signal für [[ duration ]] Sekunden",
  ":forward": "vorwärts",
  ":back": "rückwärts",
  ":left": "links",
  ":right": "rechts",
  ":start-collision": "Starte Kollisionsentdeckung",
  ":start-following": "Starte Lininenverfolgung",
  ":toolbox": "Werkzeuge",
  ":program": "Programm",
  ":drag": "Ziehe die Funktion von der linken Seite herüber",
  ":run": "Ausführen",
  ":pause": "Pause",
  ":stop": "Halt",
  ":clear": "Löschen",
  ":show-help": "Hilfe anzeigen",
  ":hide-help": "Hilfe verbergen",
  ":js-help-title": "Mirobot mit Javascript steuern",
  ":js-help-intro": "Verwenden Sie diese einfachen Befehle um mit dem Mirobot zu beginnen:",
  ":js-forward-help": "100 mm vorwärts fahren",
  ":js-back-help": "100 mm rückwärts fahren",
  ":js-left-help": "um 90 GRad nach Links drehen",
  ":js-right-help": "um 90 Grad nach Rechts drehen",
  ":js-penup-help": "Stift anheben",
  ":js-pendown-help": "Stift absetzen",
  ":js-beep-help": "Signal geben",
  ":hide-js": "Javascript verbergen",
  ":show-js": "Javascript anzeigen",
  ":100mm-grid": "Raster mit 100 mm",
  ":blockly": "Blockly",
  ":blockly-desc": "Diese App bietet erweiterte Programmiertechniken für den Mirobot",
  ":javascript": "Javascript",
  ":javascript-desc": "Programmier den Mirobot mit allen Möglichkeiten von Javascript im Browser",
  ":mirobot-ui": "Mirobot UI",
  ":mirobot-ui-desc": "Dies ist die einfache Drag-and-Drop App zur Programmierung des Mirobot",
  ":point-click": "Zeigen & Anklicken",
  ":point-click-desc": "Hier klicken um den Mirobot zu steuern und das Kontrollprogramm anzuzeigen",
  ":remote": "Fernsteuerung",
  ":remote-desc": "Mit dieser Schaltfläche den Mirobot fernsteuern",
  ":snap": "Snap!",
  ":snap-desc": "Snap! ist ähnlich zu Scratch und eignet sich gut, zusätzliche Sensoren einzubinden",
  "Move forward by %n mm": "vor fahren um %n mm",
  "Move back by %n mm": "zurück fahren um %n mm",
  "Beep for %n seconds": "Signal für %n Sekunden",
  "Stop": "Halt",
  "Bump sensor": "Stoßsensor",
  "Line sensor": "Liniensensor",
  "When I bump into something": "Sollte ich an etwas stoßen",
  "When the line sensor changes": "Wennder Liniensensor sich ändert",
  ":run-on-mirobot": "Auf Mirobot ausführen",
  ":stop-mirobot": "Mirobot anhalten",
  ":simulate-program": "Programm simulieren",
  ":reset-simulation": "Simulation zurück setzen",
  ":view-js-code": "JS Code anzeigen",
...
trans.fr = {
  ...
  ":repeat-cmd": "Répéter [[ count ]] fois",
  ":beep-cmd": "Biper pendant [[ duration ]] secondes",
  ":forward": "avant",
  ":back": "arrière",
  ":left": "gauche",
  ":right": "droite",
...
trans.pl = {
  ...
  ":connect": "Łączenie",
  ":connected": "Połączono",
  ":move-cmd": "Przesuń [[ direction ]] o [[ distance ]] mm",
  ":penup-cmd": "Podnieś pisak",
  ":pendown-cmd": "Opuść pisak",
  ":turn-cmd": "Obróć [[ direction ]] o [[ angle ]] stopni",
  ":repeat-cmd": "Powtórz [[ count ]] razy",
  ":beep-cmd": "Zagraj przez [[ duration ]] sekundę",
  ":forward": "do przodu",
  ":back": "do tyłu",
  ":left": "w lewo",
  ":right": "w prawo",
...
trans['pt-br'] = {
  ...
  ":save": "Gravar",
  ":save-as": "Gravar como",
  ":new-prog": "Novo programa",
  ":delete-prog": "Apagar programa",
  ":download": "Descarregar programa",
  ":upload": "Carregar programa",
  ":open": "Abrir programa",
  ":choose-name": "Escolha o nome do arquivo",
  ":unsaved": "Você tem alterações que serão perdidas. Você quer continuar?",
  ":exists": "Erro, um arquivo com este nome já existe",
  ":single-file": "Escolha um arquivo para carregar",
  ":sure": "Tem certeza de que quer excluir o programa",
  ":permanent": "Isto é permanente e não pode ser revertido",
  ":address": "Entre o endereço do seu Mirobot aqui",
  ":connect": "Conectar",
  ":connected": "Conectado",
  ":move-cmd": "Mover [[ direction ]] por [[ distance ]] mm",
  ":penup-cmd": "Caneta para cima",
  ":pendown-cmd": "Caneta para baixo",
  ":turn-cmd": "Gire [[ direction ]] por [[ angle ]] graus",
  ":repeat-cmd": "Repita [[ count ]] vezes",
  ":beep-cmd": "Beep por [[ duration ]] segundos",
  ":forward": "frente",
  ":back": "trás",
  ":left": "esquerda",
  ":right": "direita",
  ":start-collision": "Começe a Detecção de Colisão",
  ":start-following": "Começe a Seguir Linha",
  ":toolbox": "Caixa de ferramentas",
  ":program": "Programa",
  ":drag": "Arraste as funções da esquerda para cá",
  ":run": "Execute",
  ":pause": "Pausa",
  ":stop": "Pare",
  ":clear": "Apague",
  ":show-help": "Mostre a ajuda",
  ":hide-help": "Esconda a ajuda",
  ":js-help-title": "Controlando o Mirobot com Javascript",
  ":js-help-intro": "Use estes comandos simples para começar a controlar o Mirobot:",
  ":js-forward-help": "mova 100 mm para frente",
  ":js-back-help": "move 100 mm para trás",
  ":js-left-help": "gire 90 graus para a esquerda",
  ":js-right-help": "gire 90 graus para a direita",
  ":js-penup-help": "levante a caneta",
  ":js-pendown-help": "baixe a caneta para desenhar",
  ":js-beep-help": "faça um beep",
  ":hide-js": "Esconda o Javascript",
  ":show-js": "Mostre o Javascript",
  ":100mm-grid": "grade de 100mm",
  ":blockly": "Blockly",
  ":blockly-desc": "Este aplicativo permite técnicas avançadas de programação para o Mirobot",
  ":javascript": "Javascript",
  ":javascript-desc": "Programe o Mirobot usando o poder total do Javascript diretamente do seu navegador",
  ":mirobot-ui": "Interface Gráfica do Mirobot",
  ":mirobot-ui-desc": "Esta é uma simples aplicação arraste-e-solte usada para programar o Mirobot",
  ":point-click": "Aponte & Clique",
  ":point-click-desc": "Clique para controlar o Mirobot e ver o programa que ele irá usar",
  ":remote": "Controle Remoto",
  ":remote-desc": "Use os botões para controlar remotamente o seu Mirobot",
  ":snap": "Snap!",
  ":snap-desc": "Snap! is muito parecido com o Scratch e é bom para usar sensores no programa",
  "Move forward by %n mm": "Mova para frente por %n mm",
  "Move back by %n mm": "Mova para trás por %n mm",
  "Beep for %n seconds": "Beep por %n segundos",
  "Stop": "Pare",
  "Bump sensor": "Sensor de choque",
  "Line sensor": "Sensor de linha",
  "When I bump into something": "Quando eu bater em algo",
  "When the line sensor changes": "Quando o sensor de linha mudar",
  ":run-on-mirobot": "Executar no Mirobot",
  ":stop-mirobot": "Pare o Mirobot",
  ":simulate-program": "Simule o programa",
  ":reset-simulation": "Reinicie a Simulação",
  ":view-js-code": "Veja o código JS",
  ":clear-program": "Apague o programa"
}
trans.pt = {
  langName: "Português",
  flag: 'pt',
